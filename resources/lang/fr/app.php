...
[
    ...
    'txt.legal_owner' => 'Je / nous certifie / certifions que j\'ai / nous avons le titre légal de disposer de ce programme/produit en tant que :',
    'txt.radio_legal_owner_choix_1' => 'Propriétaire légal de ce programme/produit',
    'txt.radio_legal_owner_choix_2' => 'Titulaire d\'un mandat légal pour vendre ce programme/produit',
    ...
    'txt.certificat_acceptation' => 'J\'accepte que les certificats et la clause de non-responsabilité ci-dessus soient clairement affichés dans la publication de ce programme/produit.',
    'txt.declaration_annonceur' => 'Déclaration de l\'annonceur :',
    'txt.type_annonceur' => 'Je / nous, propriétaire / annonceur',
    'txt.confirm_creation' => "Les biens affichés sur le portail « Investir en Australie » s\'adressent à une clientèle internationale francophone composée majoritairement de personnes résidant hors des frontières australiennes et qualifiées de « Non-Resident Foreigners » par la loi australienne. Ces personnes sont confrontées à un certain nombre de limitations d\'investissement en Australie.",
    'txt.confirm_creation1' => "Par conséquent, il vous sera demandé de certifier que vous disposez d\'un titre légal pour disposer de cette propriété et qu\'elle peut être vendue à des étrangers non-résidents en vertu de la réglementation australienne sur les investissements directs étrangers appliquée par le Foreign Investment Review Board.",
