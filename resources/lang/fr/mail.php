...
return [
    ...
    */
    ...
    'to_verify' => 'Vérifier',
    'btn.email_address_confirmation' => 'Confirmation adresse email',
    ...
    'btn.submit_afa_contract_signed' => 'Soummettre le contract afa signé',
    'txt.submit_afa_contract_signed' => 'Soummettre le contract afa signé',
    'txt.afa_contract_draft' => 'Projet de contrat afa',
    'btn.submit_apl_contract_signed' => 'Soummettre le contract apl signé',
    'txt.submit_apl_contract_signed' => 'Soummettre le contract apl signé',
    'txt.apl_contract_draft' => 'Projet de contrat apl',
    'contract_signed_sent' => 'L&rsquo;:role candidate &quot;:name&quot; a retourné le contract :role signé.<br/><p><a href=:link>:txt</a></p>',
    ...
    'btn.confirm.email'=>'Confirmation email',
    'btn.continue'=>'Continuer',
    'btn.abandon'=>'Abandonner',
    'confirm.subject'=>'[:app] Confirmation Email',
    'sent'=>'Un couriel a été envoyé à votre adresse e-mail !',
];
