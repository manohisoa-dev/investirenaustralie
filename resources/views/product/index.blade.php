                ...
                <div class="col-lg-8">
                  ...
                  <section class="property-meta-wrapper common">
                          ...
                          @if ($haveDossTrans)
                                ...
                                <div class="row m-15px-t">
                                  <div class="col-sm-6">
                                    @if (Auth::user()->isComplete())
                                      <a href="{{route('member.buy.continueTransaction', $user->getCurrentDossierTransaction($item->id))}}" type="button" id="btn_buy" value="{{ Session::has('engagement')?1:0 }}" class="m-btn m-btn-theme4rd flex-shrink-0 col-md-12">
                                        <i class="fa fa-shopping-cart"></i> @lang('app.btn.add_to_cart')
                                      </a>
                                    @else
                            ...
                            @else
                              @if ($statusDossTrans==1)
                                  <div class="row m-15px-t">
                                    <div class="col-sm-6">
                                        <a href="{{route('member.buy.product.directly', $item )}}" type="button" id="btn_buy" value="1" class="m-btn m-btn-theme4rd flex-shrink-0 col-md-12">
                                          <i class="fa fa-shopping-cart"></i> @lang('app.btn.add_to_cart')
                                        </a>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                @else
                                  <div class="row m-15px-t">
                                    <div class="col-sm-6">
                                        <a href="{{route('member.buy.product.directly', $item )}}" type="button" id="btn_buy" value="{{ Session::has('engagement')?1:0 }}" class="m-btn m-btn-theme4rd flex-shrink-0 col-md-12">
                                          <i class="fa fa-shopping-cart"></i> @lang('app.btn.add_to_cart')
                                        </a>
                                    </div>
                                    <div class="col-sm-6">
                    ...
                    @else
                      <div class="row m-15px-t">
                        <div class="col-sm-12">
                            <h3 class="text-danger">@lang('app.txt.reserved_product')</h3>
                        </div>
                      </div>
                    @endif
                  </section>
...
<div id="registrationMemberMessageModal" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg">
      <div class="modal-content white-bg">
          ...
          <div class="modal-body">
            @if(Session()->get('complete_registration_content'))
              {!! Session()->get('complete_registration_content') !!}
              <div class="m-25px-b">
                <a type="button" class="m-btn m-btn-theme2nd col-md-12" href="{{ route("member.complete_registration", $item) }}" >{{ (trans('app.txt.complete_my_registration_form')) }}</a>
              </div>
              <div>
            ...
            @else
              {!! Session()->get('complete_registration_directly_content') !!}
            @endif
          </div>
          <div class="modal-footer">
              <a type="button" class="pull-left m-btn m-btn-theme" id="btn_cancel" href="javascript:void(0)" data-dismiss="modal">@lang('app.btn.abandonner')</a>
