                            ...
                            <div id="residentiel" class="tab-pane fade in active"><hr>
                                ...
                                <div class="search-row">
                                    <div class="form-group mar-r-20">
                                        <label for="price-range">Prix ( Australia Dollar AUD ) :</label>
                                ...
                                <div class="search-row">
                                    ...
                                    <div class="form-group mar-l-20">
                                        <label for="price-range">Nombre de chambre :</label>
                                ...
                                <div class="search-row">
                                    <div class="form-group mar-r-20">
                                        ...
                                        <input type="text" class="span2" name="toillet" value="" data-slider-min="1" data-slider-max="10" data-slider-step="1" data-slider-value="[5,8]" id="min-toillet">
                                        <br>
                                        <b class="pull-left color">1</b>
                                        <b class="pull-right color">10</b>
                                    </div>
                                    <div class="form-group mar-l-20">
                                        ...
                                        <input type="text" class="span2" name="bedrooms" value="" data-slider-min="1" data-slider-max="10" data-slider-step="1" data-slider-value="[5,8]" id="min-park">
                                        <br>
                                        <b class="pull-left color">1</b>
                                        <b class="pull-right color">10</b>
                                    </div>
