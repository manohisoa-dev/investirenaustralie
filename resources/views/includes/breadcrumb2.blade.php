        ...
        <div class="white-bg box-shadow-lg p-20px position-relative border-radius-5">
            <div class="extra-menu d-flex align-items-center">
                ...
                <div class="d-none d-md-block h-btn m-35px-l col-lg-11">
                    <form class="d-flex flex-row m-5px-b p-1 white-bg input-group" action="{{route('search')}}" method="post">
                        {{csrf_field()}}
                        <select id="administrative_area_level_1" class="form-control border-radius-0 border-0" name="state">
                        ...
                        <input type="text" id="locality" name="city" class="form-control border-radius-0 border-0" onFocus="geolocate()" placeholder="@lang('app.input.ville')" value="{{isset($q)?$q:''}}">
                        <input type="text" id="administrative_area_level_2" name="suburb" class="form-control border-radius-0 border-0" placeholder="@lang('app.input.suburb')" value="{{isset($q)?$q:''}}">
