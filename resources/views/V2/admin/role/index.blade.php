...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <div class="title-action">
            <a href="{{ route('V2.admin.role.create') }}" type="button" class="btn btn-primary btn-block">
	...
	<div class="col-lg-12">
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
                ...
                <thead>
                    <tr class="header-row">
						{!!\Nvd\Crud\Html::sortableTh('id','V2.admin.role.index','Id')!!}
						{!!\Nvd\Crud\Html::sortableTh('role_name','V2.admin.role.index','Rôle')!!}
						{!!\Nvd\Crud\Html::sortableTh('role_initial','V2.admin.role.index','Initiale')!!}
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="editable"
                                          ...
                                          data-url="{{ route('V2.admin.role.index')}}/{{ $record->{$record->getKeyName()} }}"
                                 ...
                                 <td>
								  ...
								  <td class="actions-cell text-center" width="7%">
								  	<a href="{{ route('V2.admin.role.index')}}/{{$record->id}}/edit" title="Modification" class="btn btn-default btn-circle">
