    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>@lang('app.txt.add_new_user_type')</h5>
            </div>
            <div class="ibox-content">
                <form class="form-validation form-padding" action="{{Auth::user()->isAdminDelegate()?route('admin.collaborators.admin.type-user.store'):route('admin.type-user.store') }}" method="post">
