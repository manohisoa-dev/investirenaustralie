...
<li class="nav-header">
    <div class="dropdown profile-element">
        ...
        <ul class="dropdown-menu animated fadeInRight m-t-xs">
            <li><a class="dropdown-item" href="{{Auth::user()->isAdmin()?route('admin.profile'):route('admin.collaborator.admin.profile')}}">Profile</a></li>
...
<li class="{{Request::is('*/admin/*') || Request::is('*/admin') || Request::is('collaborator') ? 'active' : ''}}">
    <a href="{{ Auth::user()->isAdmin()?url('/admin'):url('/collaborator') }}"><i class="fa fa-tachometer" title="Tableau de bord"></i> <span class="nav-label">Tableau de bord</span></a>
</li>
...
<li class="{{Request::is('*/blog/*') || Request::is('*/blog') || Request::is('*/comment') || Request::is('*/comment/') || Request::is('*/comment/*') ? 'active' : ''}}">
    ...
    <ul class="nav nav-second-level collapse">
        <li><a href="{{ Auth::user()->isAdmin()?route('admin.blog.create'):route('admin.collaborator.admin.blog.create') }}">Ajouter un article</a></li>
        <li><a href="{{Auth::user()->isAdmin()?route('admin.blog.index'):route('admin.collaborator.admin.blog.index') }}">Liste des blogs</a></li>
        <li><a href="{{Auth::user()->isAdmin()?route('admin.comment.index'):route('admin.collaborator.admin.comment.index') }}">Commentaires</a></li>
...
@if(!Auth::user()->isAdminBlog())
    ...
    <li class="{{Request::is('*/mail/*') || Request::is('*/mail') || Request::is('*/mails-template/*') || Request::is('*/mails-template') || Request::is('*/parameters-email/*') || Request::is('*/parameters-email') || Request::is('*/mailtype/*') ? 'active' : ''}}">
        ...
        <ul class="nav nav-second-level collapse">
			...
			<li><a href="{{route('admin.parameters-email.index')}}">Paramètres email</a></li>
