			...
			<div class="ibox-content">
                ...
                <thead>
                    <tr class="header-row">
						...
						{!!\Nvd\Crud\Html::sortableTh('title','admin.category.index','Titre')!!}
						...
						<th>Blogs</th>
						{!!\Nvd\Crud\Html::sortableTh('author_id','admin.category.index','Auteur')!!}
                            ...
                            <tr>
							   ...
							   <td class="actions-cell text-center" width="12%">
									<form class="form-inline" action="{{route('admin.category.index')}}/{{$record->id}}" method="POST">
										...
										<a href="{{route('admin.category.index')}}/{{$record->id}}/edit" title="Modification" class="btn btn-default btn-circle">
