...
<div class="wrapper wrapper-content animated fadeInRight">
	<div class="row">
		...
		<div class="col-md-3">
			<div class="ibox">
				<div class="ibox-title">
					<h5><i class="fa fa-bank"></i> @lang('app.txt.organisation')</h5>
				</div>
				<div class="ibox-content">
					<table class='table table-borderless'>
						<tr>
					...
					<table class="table boo-table table-striped table-hover">
						<thead>
							<tr>
								...
								<th scope="col">@lang('app.table.user')<span class="column-sorter"></span></th>
								<th scope="col">@lang('app.table.content') <span class="column-sorter"></span></th>
