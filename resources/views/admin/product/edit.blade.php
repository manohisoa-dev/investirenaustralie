								...
								<div class="file-box" style="width:100% !important">
									<div class="file">
										<a href="{{asset($product->imageUrl())}}" target="_blank" class="fancyboxLink">
											...
											@if (@getimagesize($product->imageUrl()))					
											<div class="image">
												<img alt="image" class="img-responsive" style="height:100%" src="{{$product->imageUrl()}}">
											</div>
											@else
											<div class="image">
												<img alt="image" class="img-fluid" src="{{asset('img/500x500.jpg')}}">
								...
								<div class="file-box" style="width:100% !important">
									<div class="file">
										<a href="{{asset($product->imageUrl())}}" target="_blank" class="fancyboxLink">
											...
											@if (@getimagesize($product->imageUrl()))					
											<div class="image">
												<img alt="image" class="img-fluid" style="height:100%" src="{{$product->imageUrl()}}">
											</div>
											@else
											<div class="image">
												<img alt="image" class="img-fluid" src="{{asset('img/500x500.jpg')}}">
	...
	function delete_eoi_dossier(id_eoi_dossier)
	{
		swal({
		 ...
		 function(isConfirm){	
		   if (isConfirm){
				 $.ajax({
					url : "{{ Auth::user()->isAdmin()?route('admin.ajaxDropEoiDossier'):route('admin.collaborators.admin.ajaxDropEoiDossier') }}",
					type: "POST",
					dataType: "JSON",
