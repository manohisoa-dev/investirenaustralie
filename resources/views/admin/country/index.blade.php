...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{ route('admin.country.index') }}">Pays</a>
            </li>
    ...
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <div class="title-action">
            <a href="{{ route('admin.country.create') }}" type="button" class="btn btn-primary btn-block">
                <i class="fa fa-plus"></i> Ajouter un nouveauPays            </a>
        </div>
    </div>
</div>
                    ...
                    <tbody>
                        @forelse ( $records as $record )
                            <tr>
                                          ...
                                          data-url="{{ route('admin.country.index')}}/{{ $record->{$record->getKeyName()} }}"
                                          >{{ $record->code }}</span>
                                                                    </td>
                                                                <td>
                                                                        <span class="editable"
                                          ...
                                          >{{ $record->placeholder }}</span>
                                                                ...
                                                                @include( 'vendor.crud.single-page-templates.common.actions', [ 'url' => route('admin.country.index'), 'record' => $record ] )
                            </tr>
                        @empty
