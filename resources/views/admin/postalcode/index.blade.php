...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{ route('admin.postalcode.index') }}">Code postaux</a>
            </li>
    ...
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <div class="title-action">
            <a href="{{ route('admin.postalcode.create') }}" type="button" class="btn btn-primary btn-block">
                    ...
                    <tbody>
                        @forelse ( $records as $record )
                            <tr>
                                          ...
                                          data-url="{{ route('admin.postalcode.index')}}/{{ $record->{$record->getKeyName()} }}"
                                          >{{ $record->content }}</span>
                                                                    </td>
                                                                <td>
                                                                ...
                                                                @include( 'vendor.crud.single-page-templates.common.actions', [ 'url' => route('admin.postalcode.index'), 'record' => $record ] )
                            </tr>
                        @empty
