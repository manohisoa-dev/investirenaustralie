  ...
  <body>
    <section class="ca-section-1">
	  ...
	  <div class="pdf-content-p1">
			...
			<p><strong>The present invoice (Initial Deposit 10%) concerns the FIRST PAYMENT (50%) of the above "Commission de Présentation de Clientèle" - CPCattributable to {{$iicc['iicc_name']->value}}.</strong></p>
			...
			<p>For your kind payment within the period of FIFTEEN DAYS (15 days) following the perception by {{$afa->name}} of the sales commission due by the seller, please use the link <a href="#"><strong>CPC ON COMMISSION FIRST PAYMENT</strong></a> included in the accompanying message.</p>
