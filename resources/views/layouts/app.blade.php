...
<body data-spy="scroll" data-target="#navbar-collapse-toggle" data-offset="98">
    ...
    {{--    <script src="https://code.jquery.com/jquery-migrate-3.6.0.min.js" integrity="sha256-/xUj+3OJU5yExlq6GSYGSHk7tPXikynS7ogEvDej/m4=" crossorigin="anonymous"></script>
            ...
            envoi.done( function(data) {
                ...
                $.each(data.res,function(key,value){
                    ...
                    envoi.done( function(url) {
                        $('#listAplModal .modal-body').append('<a href="'+url.res+'" target="_blank" class="nav-item nav-link white-color tip-top"><i class="fa fa-map-marker"></i> '+apl_orga_name+'<span class="show-apl-info">'+aplInfo+'</span></a>');
                    });
