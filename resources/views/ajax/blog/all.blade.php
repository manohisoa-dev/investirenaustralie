...
<div class="col-md-6 col-lg-6 m-30px-b view-item">
    <div class="hover-top card box-shadow-only-hover overflow-hidden border-radius-0">
        ...
        <div class="p-20px">
            ...
            <h5 class="m-10px-b font-w-600"><a title="{{$item->title}}" class="dark-color" href="{{route('blog.index',$item->slug)}}" target="_blank">{{ getGTranslateAutoDetect( App::getLocale() ,str_limit($item->title, 50, '...')) }}</a></h5>
