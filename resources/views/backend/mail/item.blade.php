<div class="property clearfix">
    ...
    <a href="{{route(App\Models\User::find(Auth::id())->roleUser->role_initial.'.mail.delete', $mail)}}" class="pull-right submit-btn btn btn-default" data-hover="@lang('app.btn.delete')" title="@lang('app.btn.delete')"><i class="fa fa-trash-alt"></i></a>
