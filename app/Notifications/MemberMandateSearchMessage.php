...
class MemberMandateSearchMessage extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->line(__('member.gothere.select_afa.mr.message_to_member', ['date'=>$dt,'hour'=>$hr,'name'=>$user->name,'immat'=>$user->immat,'etat'=>$product->location->area_level_1,'afa'=>$user->afa->name,'download_mr'=>$downloadForm6,'upload_mr'=>$uploadForm6,'abort'=>$abort]));
    }
