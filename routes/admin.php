...
Route::prefix('collaborators')->namespace('Admin')->as('admin.')->middleware(["auth","role:6"])->group(function(){
    ...
    Route::get('/admin/type-user/{type-user}', 'TypeUserController@show')->name('collaborators.admin.type-user.show');
    Route::put('/admin/type-user/{type-user}', 'TypeUserController@update')->name('collaborators.admin.type-user.update');
    Route::delete('/admin/type-user/{type-user}', 'TypeUserController@destroy')->name('collaborators.admin.type-user.destroy');
    Route::get('/admin/type-user/{type-user}/edit', 'TypeUserController@edit')->name('collaborators.admin.type-user.edit');
